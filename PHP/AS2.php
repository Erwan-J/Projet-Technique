...
{									
	if (isset($_POST['posPanneau']) && isset($_POST['inclPanneau']) && isset($_POST['I_Panneau']) && isset($_POST['I_Batterie']) &&  isset($_POST['V_Panneau']) && isset($_POST['V_Batterie']))  
	  	...
	  	$strRequete = "INSERT INTO as2 ( Position_Panneau, Inclination_Panneau, I_Panneau, I_Batterie, V_Panneau, V_Batterie ) VALUES ('".$posP."','".$inclP."','".$int."','".$ten."', '".$cap."','".$V_Batterie."')";
...
<html lang="fr">
    ...
    <label for="inclPanneau" >inclination du Panneau</label><input type="number" name="inclPanneau" id="inclPanneau" placeholder="0" min="0" ></p>
