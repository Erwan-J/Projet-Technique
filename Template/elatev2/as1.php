						...
						<?php
						   ...
						   include_once("database.php");
							   // Connexion à la base de données
								  ...
								  $inclinaison="SELECT Inclination_panneau FROM MesurePS ORDER BY id_ps DESC ";//selcetionner seulement la consommation
								  $orientation="SELECT Orientation_panneau FROM MesurePS ORDER BY id_ps DESC";
							   $tension="SELECT V_Panneau FROM MesurePS ORDER BY id_ps DESC";
							   $courant="SELECT I_Panneau FROM MesurePS ORDER BY id_ps DESC";
							   $temps_marche="SELECT Horodatage FROM MesurePS ORDER BY id_ps DESC";
								  //////////////////////////////////////////////////////
