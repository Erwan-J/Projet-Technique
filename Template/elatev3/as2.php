...
<html>
	...
	<body>
		<svg height="500" width="500">
	  		<line id="line" x1="50" y1="300" x2="200" y2="300" transform-origin="200 300" transform="rotate(<?php afficheValeur($inclinaison,$idcom)?>)" style="stroke:rgb(255,0,0); stroke-width:5" />
