<?php
						   ...
						   include_once("database.php");
							   // Connexion à la base de données
								  ...
								  $inclinaison="SELECT Inclination_panneau FROM MesurePS WHERE id_ps='2' ORDER BY ID DESC ";//selcetionner seulement la consommation
							   ...
							   $temps_marche="SELECT Horodatage FROM MesurePS  WHERE id_ps='2' ORDER BY ID DESC";
								  //////////////////////////////////////////////////////
