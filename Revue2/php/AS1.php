...
{									
	if (isset($_POST['orPanneau']) && isset($_POST['inclPanneau']) && isset($_POST['I_Panneau']) && isset($_POST['I_Batterie']) &&  isset($_POST['V_Panneau']) && isset($_POST['V_Batterie']))  
	  	...
	  	$strRequete = "INSERT INTO MesurePS (id_ps, Orientation_Panneau, Inclination_Panneau, I_Panneau, I_Batterie, V_Panneau, V_Batterie ) VALUES ( 1 ,'".$orP."','".$inclP."','".$int."','".$ten."', '".$cap."','".$V_Batterie."')";
